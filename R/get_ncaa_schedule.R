#' After running `get_ncaaw_teams()` you can then take the 'Name' and 'ID' to return that teams specific schedule
#' Return NCAA schedule dataframe object
#'
...
#'
#' @export
get_team_schedule <- function(team_name, team_id, yr) {
...
#' Or you can return a conference worth of scheduling
#' Return NCAA schedule dataframe object
#'
#' @return get_conf_schedule data.frame: 'url', 'date', 'home', 'away', 'location'
#'
#' @examples
#' \dontrun{
